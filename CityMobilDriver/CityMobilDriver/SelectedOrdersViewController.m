...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    NSString *simpleTableIdentifierIphone = [NSString stringWithFormat: @"SimpleTableOrdersSelected%d",indexPath.row];
    ...
    NSString * stringForLabelShortName = [NSString stringWithFormat:@"  %@ %@ %@",self.stringForSrochno,callDateFormat,shortName];
    ...
    NSString * stringForLabelCallMetroName =[NSString stringWithFormat:@"  %@",callMetroName] ;
